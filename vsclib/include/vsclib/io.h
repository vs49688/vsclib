...
int vsc_freadall_ex(void **ptr, size_t *size, FILE *f, VscFreadallInitProc init_proc, VscFreadallChunkProc chunk_proc,
                    void *user);
...
static inline uint16_t vsc_swap_uint16(uint16_t x)
{
    return ((x & 0x00FFU) >> 0U) << 8U | ((x & 0xFF00U) >> 8U) << 0U;
}

static inline uint32_t vsc_swap_uint32(uint32_t x)
{
    return ((x & 0x000000FFU) >> 0U) << 24U | ((x & 0x0000FF00U) >> 8U) << 16U | ((x & 0x00FF0000U) >> 16U) << 8U |
           ((x & 0xFF000000U) >> 24U) << 0U;
}

static inline uint64_t vsc_swap_uint64(uint64_t x)
{
    return ((x & 0x00000000000000FFULL) >> 0U) << 56U | ((x & 0x000000000000FF00ULL) >> 8U) << 48U |
           ((x & 0x0000000000FF0000ULL) >> 16U) << 40U | ((x & 0x00000000FF000000ULL) >> 24U) << 32U |
           ((x & 0x000000FF00000000ULL) >> 32U) << 24U | ((x & 0x0000FF0000000000ULL) >> 40U) << 16U |
           ((x & 0x00FF000000000000ULL) >> 48U) << 8U | ((x & 0xFF00000000000000ULL) >> 56U) << 0U;
}
#endif

static inline int16_t vsc_swap_int16(int16_t x)
{
    return (int16_t)vsc_swap_uint16((uint16_t)x);
}
static inline int32_t vsc_swap_int32(int32_t x)
{
    return (int32_t)vsc_swap_uint32((uint32_t)x);
}
static inline int64_t vsc_swap_int64(int64_t x)
{
    return (int64_t)vsc_swap_uint64((uint64_t)x);
}

#define VSCLIB_DECLARE_IO_X2Y2X(type, c1, c2, proc) \
    static inline type vsc_##c1##_to_##c2(type x)   \
    {                                               \
        return (type)proc(x);                       \
    }                                               \
    static inline type vsc_##c2##_to_##c1(type x)   \
    {                                               \
        return (type)proc(x);                       \
    }
