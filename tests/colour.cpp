...
TEST_CASE("colour conversions", "[colour]")
{
    SECTION("rgb565")
    {
        ...
        CHECK(0x0000u == vsc_colour_pack_rgb565({0x00, 0x00, 0x00, 0xFF}));
        CHECK(0xF800u == vsc_colour_pack_rgb565({0xFF, 0x00, 0x00, 0xFF}));
        CHECK(0x07E0u == vsc_colour_pack_rgb565({0x00, 0xFF, 0x00, 0xFF}));
        CHECK(0x001Fu == vsc_colour_pack_rgb565({0x00, 0x00, 0xFF, 0xFF}));
        CHECK(0xFFFFu == vsc_colour_pack_rgb565({0xFF, 0xFF, 0xFF, 0xFF}));
    ...
    SECTION("xrgb1555")
    {
        ...
        CHECK(0x8000u == vsc_colour_pack_xrgb1555({0x00, 0x00, 0x00, 0xFF}));
        CHECK(0xFC00u == vsc_colour_pack_xrgb1555({0xFF, 0x00, 0x00, 0xFF}));
        CHECK(0x83E0u == vsc_colour_pack_xrgb1555({0x00, 0xFF, 0x00, 0xFF}));
        CHECK(0x801Fu == vsc_colour_pack_xrgb1555({0x00, 0x00, 0xFF, 0xFF}));
        CHECK(0xFFFFu == vsc_colour_pack_xrgb1555({0xFF, 0xFF, 0xFF, 0xFF}));
